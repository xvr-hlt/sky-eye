...
model_dict = {
    'xdxd_spacenet4': {
        'filename': 'xdxd_spacenet4_solaris_weights.pth',
    ...
    'selimsef_spacenet4_resnet34unet': {
        'filename': 'selimsef_spacenet4_resnet34unet_solaris_weights.pth',
    ...
    'selimsef_spacenet4_densenet121unet': {
        'filename': 'selimsef_spacenet4_densenet121unet_solaris_weights.pth',
    ...
    'selimsef_spacenet4_densenet161unet': {
        'filename': 'selimsef_spacenet4_densenet161unet_solaris_weights.pth',
